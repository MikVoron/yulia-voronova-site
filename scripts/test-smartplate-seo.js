...
assert.match(index, /rel="image_src" href="https:\/\/plate\.voronova\.online\/images\/smartplate-share-v2\.jpg"/);
assert.match(index, /property="og:image" content="https:\/\/plate\.voronova\.online\/images\/smartplate-share-v2\.jpg"/);
assert.match(index, /property="og:image:url" content="https:\/\/plate\.voronova\.online\/images\/smartplate-share-v2\.jpg"/);
...
assert.match(read('index-seo.js'), /image: 'https:\/\/plate\.voronova\.online\/images\/smartplate-share-v2\.jpg'/);
...
assert(fs.statSync(path.join(platform, 'images', 'smartplate-share-v2.jpg')).size > 0);
