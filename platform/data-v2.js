...
RECIPES['buckwheat-soup'] = {
    ...
    photo: '../images/img-guides/plant-based/buckwheat-soup.webp',
    ...
    steps: [
        'Обжариваем в небольшом количестве оливкового масла лук. Добавляем специи и обжариваем ещё 1 мин. Добавляем томатную пасту, перемешиваем. Вводим морковь, тщательно перемешиваем, добавляем пару ложек воды и тушим около 7–9 мин.',
        'Вливаем воду, доводим до кипения, добавляем овощной концентрат. Следом кладём натёртый на тёрке или порезанный кубиками картофель и предварительно промытую в воде гречку. Перемешиваем.',
        'Убавляем огонь и варим до готовности гречки.',
        'Если у вас другие пропорции воды и гречки и вы боитесь сделать слишком густой суп — гречку можно отварить отдельно до готовности.',
        'В этом случае варим суп до готовности картофеля, вводим готовую гречку, доводим до кипения и выключаем. Даём супу настояться 30 мин. и подаём.',
    ],
    vkVideo: null,
    addProtein: [], addFat: [], addCarbs: [], addFiber: [],
};
