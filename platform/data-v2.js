        ...
        if (this.isGuest()) {
            ...
            return {
                ...
                description: isSubscriptionRecipe
                    ? 'Этот рецепт откроется по подписке. В ней — все ингредиенты, шаги приготовления, список покупок и конструктор тарелки.'
                ...
                btn: isSubscriptionRecipe ? 'Открыть доступ к рецепту' : 'Открыть рецепт бесплатно',
                href: this._loginUrlForRecipe(level),
                noteLines: isSubscriptionRecipe
                    ? [
                        'После регистрации — 7 дней бесплатно к пробным рецептам. Карту привязывать не нужно.',
                    ]
                    : [
