...
Подготовительная непривилегированная репетиция изолированного PM2 прошла 5/5
сценариев сохранения/возврата конфигурации (см. README helper). Она не проверяет
UID 997, boot recovery или связь событий протокола с evidence ОС и не даёт
допуска к production-релизу.
