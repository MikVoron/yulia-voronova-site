...
## Подготовленная Linux-репетиция v1 — 2026-09-10
...
21/21, без пропусков. Реальный root/systemd прогон ещё ожидает пользователя.
...
### Запуск пользователем через Timeweb
