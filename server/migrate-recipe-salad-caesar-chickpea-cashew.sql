-- Рецепт: Салат Цезарь с нутом и соусом из кешью
...
--   • sort_order=0 — назначить вручную, когда появится нужная позиция в каталоге
--
-- ПРИМЕЧАНИЕ: КБЖУ дано в десятых (316,6 / 13,5 / 15,4 / 34,5 / 8,1).
-- Схема recipes хранит целые числа, поэтому значения округлены до 317 / 14 / 15 / 35 / 8.
...
INSERT INTO recipes (
  ...
  'salads',
  'Салат Цезарь с нутом и соусом из кешью',
  NULL,
  30,
  NULL,
  'easy',
  ...
  '[
    {"name": "Нут отварной: 250 г", "swap": "Консервированный нут"},
