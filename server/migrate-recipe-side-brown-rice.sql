...
INSERT INTO recipes (
  ...
  '[
    {"text": "Замочите рис в холодной воде минимум на 60 минут, чтобы он стал мягче и быстрее сварился. Оптимально оставить на 2–4 часа, тогда он сварится более равномерно. Для максимально мягкой текстуры можно замочить на 6–8 часов или на ночь.", "photo": null},
    {"text": "Слейте воду после замачивания и промойте рис.", "photo": null},
    {"text": "Залейте рис водой, добавьте соль.", "photo": "images/recipes/side-brown-rice/side-brown-rice-3.webp"},
    {"text": "Варите 25 минут, если рис был замочен. Если рис не замачивать, варите 35–45 минут.", "photo": null},
    {"text": "При желании можно залить большим количеством воды и потом слить, как макароны.", "photo": null}
  ]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
